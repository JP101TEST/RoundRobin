...
public class Controller {
    ...
    public void addIoUsbProcess() {
        if (this.joblist.size() > 0) {// T0-01 เช็คว่า joblist มีมากกว่า 0
            ...
            } else {//ถ้ากด add Io Usb ตอนนั้นแล้ว Process ไม่ใช่ Running จะแจ้งเตือน
                checkNoReadyProcees();
            }
        } else {
    ...
    public void addIoCdProcess() {
        if (this.joblist.size() > 0) {// T0-01 เช็คว่า joblist มีมากกว่า 0
            ...
            } else {//ถ้ากด add Io Cd ตอนนั้นแล้ว Process ไม่ใช่ Running จะแจ้งเตือน
                checkNoReadyProcees();
            }
        } else {
            JOptionPane.showMessageDialog(null, "No Process In Job Queue");
    ...
    public void endIoUsbProcess() {
        if (this.ioUsblist.size() > 0) {// T0-01 เช็คว่า ioUsblist มีมากกว่า 0
            ...
            JOptionPane.showMessageDialog(null, "No Io In Io Usb Queue");
        }
        return;
    }
    ...
    public void endIoCdProcess() {
        if (this.ioCdlist.size() > 0) {// T0-01 เช็คว่า ioCdlist มีมากกว่า 0
            ...
            JOptionPane.showMessageDialog(null, "No Io In Io Cd Queue");
        }
        return;
    }
    ...
    public void terminateProcess() {
        if (this.joblist.size() > 0) {// T0-01
            ...
            } else {//ถ้ากด terminate ตอนนั้นแล้ว Process ไม่ใช่ Running จะแจ้งเตือน
                checkNoReadyProcees();
            }
        } else {
            JOptionPane.showMessageDialog(null, "No Process In Job Queue");
    ...
    private void checkNoReadyProcees() {
        int radyListCount = 0;
        for (int i = 0; i < joblistSize(); i++) {//loop หาค่า Ready
            if (this.joblist.get(i).getStatusProcess() == statusProcess[1]) {
                radyListCount += 1;
        ...
        if (radyListCount > 0) {
            JOptionPane.showMessageDialog(null, "This Status Process Is Not Running");
        } else {
            JOptionPane.showMessageDialog(null, "ALL Process Don't Have Status Ready");
        }
    }
}
